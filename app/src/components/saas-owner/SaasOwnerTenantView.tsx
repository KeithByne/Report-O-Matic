  ...
  return (
    <div className="min-h-screen bg-emerald-100/80 text-zinc-950">
        ...
        <div className="mx-auto flex max-w-5xl items-center justify-between gap-3 px-5 py-4">
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <div className="mt-1 text-lg font-semibold tracking-tight">School details</div>
            </div>
          </div>
      ...
      <main className="mx-auto max-w-5xl space-y-6 px-5 py-6">
        ...
        {busy && !data ? <div className="text-sm text-zinc-600">Loading…</div> : null}
        ...
        {data ? (
          <>
            <section className="rounded-2xl border border-zinc-200 bg-white p-5 shadow-sm">
              <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
                ...
                <div className="grid grid-cols-3 gap-2">
                  ...
                  <div className="rounded-xl border border-zinc-200 bg-zinc-50 p-3">
                    <div className="text-[11px] font-semibold uppercase tracking-wide text-zinc-500">Reports</div>
              ...
              <div className="mt-3 grid gap-3 sm:grid-cols-3">
                {["owner", "department_head", "teacher"].map((role) => (
                  <div key={role} className="rounded-xl border border-zinc-200 bg-zinc-50 p-4">
                    <div className="text-xs font-semibold uppercase tracking-wide text-zinc-500">{role.replace("_", " ")}</div>
            ...
            <section className="rounded-2xl border border-zinc-200 bg-white p-5 shadow-sm">
              <div className="text-sm font-semibold text-zinc-900">Classes (first 500)</div>
            ...
            <section className="rounded-2xl border border-zinc-200 bg-white p-5 shadow-sm">
              <div className="text-sm font-semibold text-zinc-900">Students (first 200)</div>
              <div className="mt-3 overflow-x-auto">
                <table className="w-full min-w-[800px] text-left text-sm">
                  <thead>
                    <tr className="border-b border-zinc-200 text-xs text-zinc-500">
                      <th className="py-2 pr-3 font-medium">Name</th>
                      <th className="py-2 pr-3 font-medium">Class ID</th>
                      <th className="py-2 pr-3 font-medium">ID</th>
                    </tr>
                  </thead>
                  <tbody>
            ...
            <section className="rounded-2xl border border-zinc-200 bg-white p-5 shadow-sm">
              <div className="text-sm font-semibold text-zinc-900">Recent reports (last 50)</div>
              <div className="mt-3 overflow-x-auto">
                <table className="w-full min-w-[900px] text-left text-sm">
                  <thead>
                    <tr className="border-b border-zinc-200 text-xs text-zinc-500">
                      ...
                      <th className="py-2 pr-3 font-medium">Report ID</th>
                    </tr>
                  </thead>
                  <tbody>
                    {data.reports.map((r) => (
