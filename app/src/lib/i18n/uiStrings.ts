...
const EN: UiMessages = {
  ...
  "support.panelLead": "Message Report-O-Matic — we usually reply by email when needed.",
  "support.messagePlaceholder": "Describe your question or issue…",
  ...
  "support.errLoad": "Could not load messages.",
