...
const EN: UiMessages = {
  ...
  "support.newCaseTitle": "Report an issue",
  "support.newCaseLead": "Describe the problem so we can help. You will get a case number.",
  "support.newCaseButton": "New issue",
  "support.noCasesYet": "No support cases yet. Tap New issue to open one.",
  "support.statusOpen": "Open",
  "support.statusResolved": "Resolved",
  "support.unreadReply": "New reply",
  "support.fieldSubject": "Subject",
  "support.fieldCategory": "Category",
  "support.fieldDescription": "What happened?",
  "support.fieldDescriptionPlaceholder": "Steps to reproduce, error messages, class or report affected…",
  "support.submitCase": "Submit issue",
  "support.submittingCase": "Submitting…",
  "support.caseResolved": "This case is resolved. You can read the history below.",
  "support.category.missing": "There is Something Missing",
  "support.category.how_to": "Questions about How to",
  "support.category.training": "Training and where to get it",
  "support.category.billing": "Billing",
  "support.category.reports": "Reports",
  "support.category.account": "Account",
  "support.category.technical": "Technical",
  "support.category.other": "Other",
  "support.messagePlaceholder": "Add a follow-up message…",
  "support.send": "Send message",
  "support.sending": "Sending…",
  "support.emptyThread": "No messages yet. Send a note and we will reply here.",
  "support.unreadBadge": "New reply",
  "support.newReplyTitle": "Support replied",
  "support.newReplyToast": "You have a new reply. Open Contact to read it.",
  "support.errLoad": "Could not load support cases.",
  "support.errSend": "Could not send message.",
  "header.nameNotSet": "—",
  ...
  "dash.panelPupils": "Pupils",
  "dash.panelClassesGroup": "Classes",
  "dash.pupilsHint":
    "Search the school list, filter by active or inactive, add a pupil, place them in a class, archive, or reactivate.",
  "dash.pupilsFilterAll": "All",
  "dash.pupilsEmptyFilter": "No pupils match this filter.",
  "dash.pupilsPlaceClass": "Choose class…",
  "dash.pupilsPlaceButton": "Place in class",
  "dash.guide.pupilsTitle": "Pupils",
  "dash.guide.pupils1": "Open Pupils for the full school list — active and inactive in one place.",
  "dash.guide.pupils2": "Search or filter, add a name, then Place in class. Archive or reactivate from the same list.",
  "dash.guide.pupils3": "Use Open class on a row to jump straight into that class’s pupil list.",
  ...
  "class.guide.importFromOther3": "Use Place from the school Pupils list if the pupil should stay in more than one class.",
  ...
  "timetable.emptyCellModeLabel": "How to fill this slot",
  "timetable.modeExisting": "Existing class",
  "timetable.modeNew": "Create new class",
  "timetable.newClassNameLabel": "Class name",
  "timetable.pickTeacher": "Teacher",
  "timetable.createClassAndAssign": "Create class and place here",
  "timetable.newClassNeedName": "Enter a name for the new class.",
  "timetable.newClassNeedTeacher": "Choose a teacher for the new class.",
  ...
  "timetable.printModeByClass": "By class",
  "timetable.overviewRoomsPerPageLabel": "Rooms per overview page",
  "timetable.displayDensityLabel": "Grid density",
  "timetable.displayDensityComfortable": "Comfortable",
  "timetable.displayDensityCompact": "Compact",
  ...
  "dash.pdfLetterheadContact": "Contact on PDF",
  "dash.pdfLetterheadContactLayout": "Contact layout",
  "dash.pdfLetterheadContactInline": "One line",
  "dash.pdfLetterheadContactStacked": "Three lines",
  "dash.pdfLetterheadPhone": "Telephone",
  "dash.pdfLetterheadMobile": "Mobile",
  "dash.pdfLetterheadEmail": "Email",
  "dash.pdfLetterheadPhonePlaceholder": "Landline number",
  ...
  "class.studentsActionsLabel": "Pupil actions",
  ...
  "class.studentsActionPlace": "Place student",
  "class.placePupilHint":
    "Search school pupils not already in {className}. Place brings them here (moves from another class, or enrolls if they are unplaced).",
  "class.placePupilButton": "Place in this class",
  "class.placePupilConfirmMove": "Move {who} into {to}? Their reports for this year will follow.",
  "class.guide.placeTitle": "Place student",
  "class.guide.place1": "Search the school list for pupils who are not already in this class.",
  "class.guide.place2": "Place enrolls them here — from another class, the roster, or inactive.",
  "class.guide.place3": "After placing, you return to this class list with the pupil highlighted.",
  ...
  "class.importFromOtherClassHint":
    "Search the whole school by name — every class, plus inactive pupils. Import moves them here with their reports (or reactivates them if they were inactive).",
  ...
  "class.importFromOtherClassFromInactive": "Inactive / deactivated (school list)",
  "class.importFromOtherClassFromRoster": "On school list (not in a class)",
  "class.importFromOtherClassButton": "Import to this class",
  "class.importFromOtherClassEmpty": "No pupils match your search across the school.",
...
const FR: UiMessages = {
  ...
  "dash.panelPupils": "Élèves",
  "dash.panelClassesGroup": "Classes",
  "dash.pupilsHint":
    "Recherchez dans la liste de l’école, filtrez actif/inactif, ajoutez un élève, placez-le dans une classe, archivez ou réactivez.",
  ...
  "dash.pupilsPlaceButton": "Placer dans une classe",
  "dash.guide.pupilsTitle": "Élèves",
  "dash.guide.pupils1": "Ouvrez Élèves pour toute la liste de l’école — actifs et inactifs au même endroit.",
  "dash.guide.pupils2": "Recherchez ou filtrez, ajoutez un nom, puis Placez dans une classe. Archivez ou réactivez depuis la même liste.",
  "dash.guide.pupils3": "Utilisez Ouvrir la classe sur une ligne pour aller directement à la liste de cette classe.",
  ...
  "class.studentsActionsLabel": "Actions sur les élèves",
  ...
  "class.studentsActionPlace": "Placer un élève",
  "class.placePupilHint":
    "Recherchez les élèves de l’école qui ne sont pas déjà dans {className}. Placer les amène ici (déplacement depuis une autre classe, ou inscription s’ils n’ont pas de classe).",
  "class.placePupilButton": "Placer dans cette classe",
  "class.placePupilConfirmMove": "Déplacer {who} vers {to} ? Ses rapports de l’année suivront.",
  "class.guide.placeTitle": "Placer un élève",
  "class.guide.place1": "Recherchez dans la liste de l’école les élèves qui ne sont pas déjà dans cette classe.",
  "class.guide.place2": "Placer les inscrit ici — depuis une autre classe, la liste, ou inactifs.",
  "class.guide.place3": "Après le placement, vous revenez à la liste de cette classe avec l’élève mis en évidence.",
  ...
  "class.importFromOtherClassFromInactive": "Inactif / désactivé (liste de l’école)",
  "class.importFromOtherClassFromRoster": "Sur la liste de l’école (pas dans une classe)",
  "class.importFromOtherClassButton": "Importer dans cette classe",
  "class.importFromOtherClassEmpty": "Aucun élève de l’école ne correspond à votre recherche.",
  "class.importFromOtherClassConfirm":
...
const ES: UiMessages = {
  ...
  "dash.panelPupils": "Alumnos",
  "dash.panelClassesGroup": "Clases",
  "dash.pupilsHint":
    "Busque en la lista escolar, filtre activos/inactivos, añada un alumno, colóquelo en una clase, archive o reactive.",
  ...
  "dash.pupilsPlaceButton": "Colocar en clase",
  "dash.guide.pupilsTitle": "Alumnos",
  "dash.guide.pupils1": "Abra Alumnos para la lista completa — activos e inactivos en un solo sitio.",
  "dash.guide.pupils2": "Busque o filtre, añada un nombre y Coloque en clase. Archive o reactive desde la misma lista.",
  "dash.guide.pupils3": "Use Abrir clase en una fila para ir a la lista de esa clase.",
  ...
  "class.studentsActionsLabel": "Acciones sobre alumnos",
  ...
  "class.studentsActionPlace": "Colocar alumno",
  "class.placePupilHint":
    "Busque alumnos de la escuela que aún no estén en {className}. Colocar los trae aquí (mueve desde otra clase, o inscribe si no tienen clase).",
  "class.placePupilButton": "Colocar en esta clase",
  "class.placePupilConfirmMove": "¿Mover a {who} a {to}? Sus informes del año viajarán con él.",
  "class.guide.placeTitle": "Colocar alumno",
  "class.guide.place1": "Busque en la lista escolar alumnos que aún no estén en esta clase.",
  "class.guide.place2": "Colocar los inscribe aquí — desde otra clase, la lista, o inactivos.",
  "class.guide.place3": "Tras colocar, vuelve a la lista de esta clase con el alumno resaltado.",
  ...
  "class.importFromOtherClassFromInactive": "Inactivo / desactivado (lista de la escuela)",
  "class.importFromOtherClassFromRoster": "En la lista de la escuela (sin clase)",
  "class.importFromOtherClassButton": "Importar a esta clase",
  "class.importFromOtherClassEmpty": "Ningún alumno de la escuela coincide con su búsqueda.",
  "class.importFromOtherClassConfirm":
