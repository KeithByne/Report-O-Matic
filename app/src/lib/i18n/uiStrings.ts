...
const EN: UiMessages = {
  ...
  "dash.pdfPreviewPrintHint": "Use Print in the viewer toolbar below, or press Ctrl/Cmd+P.",
...
const FR: UiMessages = {
  ...
  "dash.pdfPreviewPrintHint": "Utilisez Imprimer dans la barre d’outils ci-dessous, ou Ctrl/Cmd+P.",
...
const ES: UiMessages = {
  ...
  "dash.pdfPreviewPrintHint": "Use Imprimir en la barra del visor o pulse Ctrl/Cmd+P.",
