...
> = {
  nl: {
    ...
    "class.customSubjectsLead":
      "Hernoem of verwijder vakken die u aan de scholenlijst hebt toegevoegd. Vooraf ingestelde codes kunt u hier niet wijzigen. Verwijderen zet klassen die het gebruikten op het standaardvak Engels.",
    ...
    "class.confirmDeleteCustomSubject":
      "«{name}» uit de vakkenlijst van deze school verwijderen? Klassen die het gebruikten krijgen het standaardvak Engels als standaard.",
  ...
  pl: {
    ...
    "class.customSubjectsLead":
      "Zmień nazwę lub usuń przedmioty dodane do listy szkoły. Kodów z listy nie edytuje się tutaj. Po usunięciu klasy, które go używały, mają domyślnie przedmiot angielski ze standardowej listy.",
    ...
    "class.confirmDeleteCustomSubject":
      "Usunąć „{name}” z listy przedmiotów tej szkoły? Klasy, które go używały, dostaną domyślnie przedmiot angielski ze standardowej listy.",
  ...
  ro: {
    ...
    "class.customSubjectsLead":
      "Redenumiți sau eliminați disciplinele adăugate la lista școlii. Codurile predefinite nu se schimbă aici. La ștergere, clasele afectate trec la disciplina de engleză implicită.",
    ...
    "class.confirmDeleteCustomSubject":
      "Eliminați „{name}” din lista de discipline a școlii? Clasele care o foloseau vor avea implicit disciplina de engleză prestabilită.",
  ...
  ru: {
    ...
    "class.customSubjectsLead":
      "Переименуйте или удалите предметы, добавленные в список школы. Предустановленные коды здесь не меняются. При удалении классы, которые его использовали, получают предмет «английский» по умолчанию.",
    ...
    "class.confirmDeleteCustomSubject":
      "Удалить «{name}» из списка предметов этой школы? Классы, где он был, перейдут на предмет «английский» по умолчанию.",
  ...
  uk: {
    ...
    "class.customSubjectsLead":
      "Перейменуйте або приберіть предмети, додані до списку школи. Налаштовані коди тут не змінюються. Після видалення класи, що їх використовували, отримають стандартний предмет з англійської.",
    ...
    "class.confirmDeleteCustomSubject":
      "Прибрати «{name}» зі списку предметів цієї школи? Класи, що його використовували, матимуть за замовчуванням стандартний предмет з англійської.",
  ...
  ar: {
    ...
    "class.customSubjectsLead":
      "أعد تسمية المواد أو احذفها من قائمة المدرسة. الرموز الجاهزة لا تُعدّل هنا. عند الحذف، الصفوف التي كانت تستخدم المادة تنتقل إلى مادة الإنجليزية الافتراضية.",
    ...
    "class.confirmDeleteCustomSubject":
      "إزالة «{name}» من قائمة مواد هذه المدرسة؟ الصفوف التي كانت تستخدمها ستصبح افتراضيًا على مادة الإنجليزية الافتراضية.",
