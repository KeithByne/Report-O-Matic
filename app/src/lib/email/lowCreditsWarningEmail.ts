...
const LOW_CREDIT_COPY: Partial<Record<ReportLanguageCode, Copy>> = {
  en: {
    ...
    greeting: "Hello,",
    body: "Your school account is running low on report credits.",
  ...
  fr: {
    ...
    greeting: "Bonjour,",
    body: "Le compte de votre école manque bientôt de crédits de bulletin.",
  ...
  es: {
    ...
    greeting: "Hola,",
    body: "La cuenta de su centro se está quedando sin créditos de informes.",
  ...
  de: {
    ...
    greeting: "Hallo,",
    body: "Ihr Schulkonto hat nur noch wenige Bericht-Credits.",
  ...
  it: {
    ...
    greeting: "Buongiorno,",
    body: "L'account della tua scuola sta esaurendo i crediti report.",
  ...
  pt: {
    ...
    greeting: "Olá,",
    body: "A conta da sua escola está com poucos créditos de relatórios.",
