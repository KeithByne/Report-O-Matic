...
export const REPORT_PDF_LAYOUT_VERSION = 18;
...
/** Rounded rectangles around each criteria block (classroom behaviour, direct skills, indirect skills). */
export const PDF_GRADES_DIVISION_BOX_V1 = {
  cornerRadiusPt: 3.5,
  strokeWidthPt: 1.15,
