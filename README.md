...
**OTP email format:** sign-in codes are sent as **multipart** email (plain **text** plus styled **HTML**) so clients can show formatting while a text part remains for strict filters.
